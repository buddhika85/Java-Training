...
public class ArithmeticView 
{
    ...
    private void observeModelAndUpdateControls() 
    {
        ...
        diffLabel.textProperty().bind(model.diffProperty().asString());
        prodLabel.textProperty().bind(model.prodProperty().asString());
    ...
    private void createAndLayoutControls() 
    {
        ...
        HBox diffRow = new HBox(5, new Label("Diff:"), diffLabel);
        diffRow.setAlignment(Pos.CENTER);

        HBox prodRow = new HBox(5, new Label("Product:"), prodLabel);
