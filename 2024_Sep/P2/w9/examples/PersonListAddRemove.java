...
public class PersonListAddRemove extends Application {
    ...
    public void start(Stage primaryStage) 
    {
        ...
        addPersonButton.setOnAction(event -> createAddPersonForm(primaryStage, listView, data));
    ...
    private void createAddPersonForm(Stage primaryStage, ListView<Person> listView, ObservableList<Person> data) 
    {
