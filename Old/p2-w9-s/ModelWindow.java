...
public class ModelWindow extends Application 
{

    boolean isPersoninitialised;
    Person person;
    Label personDetailsLbl;
    ...
    public void start(Stage primaryStage) 
    {
        ...
        personDetailsLbl = new Label("No person has been set");
        Button setPersonBtn = new Button("Set person");

        setPersonBtn.setOnAction(event -> createForm(primaryStage));

        VBox root = new VBox(5, personDetailsLbl, setPersonBtn);
    ...
    private void createForm(Stage primaryStage) 
    {
        ...
        submitBtn.setOnAction(event -> {
            if (!this.isPersoninitialised) {
                ...
                this.personDetailsLbl.setText(this.person.toString());      // update label
