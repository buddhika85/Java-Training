...
public class FlameOneGrahicsExample extends Application 
{
    ...
    private Region createContent() 
    {
        ...
        ArrayList<Image> swirl = getFlame();                               // returns an array list of Image objects read from 'water_swirl' folder of the projects root folder
    ...
    ArrayList<Image> getFlame() 
    {
        ArrayList<Image> images = new ArrayList<>();
        for (int i = 0; i <= 27; i++)                        // 0 to 40
        {
            String filename;
            String folderPath = "./flame1/";
            filename = folderPath + i + ".png";
            if (i < 10)
                filename = folderPath + "0" + i + ".png";
            URL url = this.getClass().getResource(filename);
            images.add(new Image(url.toExternalForm(), 100.0, 100.0, true, true));
        }
        return images;
    }
